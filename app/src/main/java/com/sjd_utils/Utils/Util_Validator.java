...
public class Util_Validator {
     ...
     * 正则表达式:验证11位手机号
     */
    public static final String REGEX_MOBILE11 = "^1\\d{10}$";
...
//    public static final String REGEX_URL = "http(s)?://([\\w-]+\\.)+[\\w-]+(/[\\w-./?%&=]*)?";
     ...
     * @return 校验通过返回true，否则返回false
     */
    public static boolean isMobile11(String mobile) {
        return Pattern.matches(REGEX_MOBILE11, mobile);
    }
